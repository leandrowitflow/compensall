        ...
        {activeTab === "Assisted" ? (
          ...
          <div className="text-center py-8">
            <p className="text-[#1f3664]/60 text-sm mb-4">
              {activeTab === "Smart"
                ? "Upload your boarding pass and let our AI handle the rest automatically."
    ...
    <>
      ...
      {step === 2 && (
        <div className="text-center py-4">
          ...
          <p className="text-[#1f3664]/60 text-sm mb-6">Our AI is verifying your claim. This takes just a moment.</p>
          <button
            onClick={() => setStep(1)}
