      ...
      blocks: [
        {
          ...
          content: [
            {
              type: "text",
              text: "Alguns cookies podem ser definidos por prestadores de infraestrutura ou serviços que nos ajudam a alojar e operar o website, como fornecedores de alojamento, segurança e desempenho. Quando aceita cookies de análise, utilizamos o Google Tag Manager e tags de medição Google associadas (Google Ireland Limited / Google LLC), que podem incluir o Google Analytics, e o Meta Pixel (Meta Platforms Ireland Limited / Meta Platforms, Inc.) para medição e optimização de publicidade. A Google e a Meta podem definir cookies e tratar dados de utilização de acordo com as suas políticas. Os cookies de análise e publicidade só são colocados depois de escolher “Aceitar todos”.",
            },
          ],
        },
      ],
